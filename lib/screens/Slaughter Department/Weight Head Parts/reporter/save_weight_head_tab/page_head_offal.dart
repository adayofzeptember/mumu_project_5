...
import '../../../../../alert_components/showImageGirdForSelect.dart';
            ...
            children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: FormDropdown(
                          ...
                          value: weightNo,
                          items: state.balance_id_device_dropdown,
                          onChanged: (value) {
                            setState(() {
                              weightNo = value;
                            });
              ...
              Column(
                ...
                children: [
                  ...
                  FormShowDialog(
                    onTap: () async {
                      secType = await showImageGirdForSelect(
                          context, "เลือกส่วนรองพื้น (ถ้ามี)");
                      setState(() {});
                    },
                    value: secType,
                  ),
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        FormShowDialog(
                          valueColor: colorSizeCart != null
                              ? colorSizeCart!['color']
                              : null,
                          value: colorSizeCart != null
                              ? "${colorSizeCart!['name']} - ${colorSizeCart!['size']}"
                              : null,
                          onTap: () async {
                            colorSizeCart =
                                await showColorCart(context, colorSizeCart);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FormShowDialog(
                          ...
                          onTap: () async {
                            nameProduct =
                                await showImageGirdForSelect(context, "สินค้า");
                            print(nameProduct);
