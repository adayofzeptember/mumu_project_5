                  ...
                  child: Form(
                    ...
                    child:
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'ชั่งน้ำหนักสุกร',
                            style:
                                TextStyle(color: Palette.mainRed, fontSize: setFontSize(context, 0.035), fontWeight: FontWeight.bold),
                          ),
                          Row(
                            children: [
                              Text(
                                        ...
                                        .map((item) => DropdownMenuItem<String>(
                                              ...
                                              child: Text(
                                                ...
                                                style: const TextStyle(
                                                    fontWeight: FontWeight.bold, fontSize: 20, color: Palette.mainRed),
                                              ),
                                            ))
                                        .toList(),
                                    onChanged: (value) {
                            ...
                            child: DropdownButton2(
                              ...
                              items: ['test']
                                  .map((item) => DropdownMenuItem<String>(
                                        ...
                                        child: Text(
                                          item,
                                          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Palette.mainRed),
                                        ),
                                      ))
                                  .toList(),
                              onChanged: (value) {
                      ...
                      TextFormField(
                        ...
                        style: TextStyle(fontSize: setFontSize(context, 0.04), color: Colors.black, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(
                        height: setHeight(context, 0.02),
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          buildCustomBox('น้ำหนักที่ชั่ง', '2s', context, 0.025),
                          buildCustomBox('เกรดสุกร', '2s', context, 0.025),
                          buildCustomBox('ลักษณะสุกร', '2s', context, 0.025),
                          buildCustomBox('ประเภทชั่ง', '2s', context, 0.025),
                        ],
                      ),
                      SizedBox(
                        height: setHeight(context, 0.03),
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              "+ เพิ่ม",
                              style:
                                  TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: setFontSize(context, 0.04)),
                            ),
                          ),
                        ),
                      ),
          ...
          Container(
            ...
            child: Center(
              child: Align(
                ...
                child: Text(
                  value,
                  style: TextStyle(fontSize: setFontSize(context, 0.025), color: Colors.blueGrey),
                ),
              ),
            ),
          ),
