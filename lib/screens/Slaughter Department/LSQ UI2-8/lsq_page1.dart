...
class _LSQ_Page1State extends State<LSQ_Page1> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LsqBloc, LsqState>(
        ...
        child: RawScrollbar(
            ...
            child: SingleChildScrollView(
              child: Padding(
                  ...
                  child: BlocBuilder<ArrivalDailyBloc, ArrivalDailyState>(
                    builder: (context, state) {
                      return Form(
                        child: Column(
                            ...
                            children: [
                                      ...
                                      onPressed: () {
                                        context
                                            ...
                                            .add(SaveLSQ_UI281(
                                              ...
                                              get_balanceId: 1,
                                              getB: _b.text.toString(),
                                              getBF3: _bf3.text.toString(),
                                              getBF4: _bf4.text.toString(),
                                              get_weight:
                              ...
                              Container(
                                decoration: BoxDecoration(
                                    border: Border.all(color: Palette.someGrey),
                                    borderRadius:
