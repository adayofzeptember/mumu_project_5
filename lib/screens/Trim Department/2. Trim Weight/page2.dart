...
class TrimWeight_Page2 extends StatefulWidget {
  const TrimWeight_Page2({super.key});

  @override
  State<TrimWeight_Page2> createState() => _TrimWeight_Page2State();
}

class _TrimWeight_Page2State extends State<TrimWeight_Page2> {
  @override
  void initState() {
