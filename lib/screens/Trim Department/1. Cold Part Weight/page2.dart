...
class ColdParts_Page2 extends StatefulWidget {
  const ColdParts_Page2({super.key});

  @override
  State<ColdParts_Page2> createState() => _ColdParts_Page2State();
}

class _ColdParts_Page2State extends State<ColdParts_Page2> {
  @override
  void initState() {
